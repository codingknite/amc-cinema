...
export function bookingsInfo(bookedInfo, action) {
    switch (action.type) {
        case 'ADD_BOOKEDINFO':
            ...
            return [...filteredArray, { id: action.movieId, adults: action.adults, kids: action.kids, seniors: action.seniors, date: action.date, cinema: action.cinema, screen: action.screen }];
